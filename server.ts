    ...
    try {
      ...
      if (result && result.foods && Array.isArray(result.foods)) {
        ...
        for (const f of result.foods) {
          ...
          // Force mathematical code-based calculation for all foods to prevent AI estimating errors
          const finalUnit = enrichedItem.unit || f.unit || "unidade";
          const finalName = enrichedItem.food_name || f.food_name || "";
          ...
          enrichedItem.grams_per_unit = exactMathGrams;
